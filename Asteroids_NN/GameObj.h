...
enum {	KIND_GENERIC, KIND_ASTEROID, 
		KIND_UFO_CHASING, KIND_UFO_NEUTRAL, 
		KIND_SHIP, KIND_BULLET, 
		KIND_CORPSE, KIND_CORPSE_SHIP };
...
public:
	...
	static CDirectSound m_sndLaser;
	static CDirectSound m_sndBigLaser;
	static CDirectSound m_sndHyperspace;

	static void DrawShip( CDC *pDC, CCoord Center, double Conv, double direction, double size, bool shield, bool thrust );
};
